...
namespace Illuminate\Support {
     ...
     */        class Collection {
         ...
         * @return \Illuminate\Support\Collection 
         * @static 
         */        public static function dataGet($key, $collection = true)
        {
                        return \Illuminate\Support\Collection::dataGet($key, $collection);
        }
                    /**
         * 
         *
        ...
        {
                        return \Illuminate\Support\Collection::dataSet($key, $value);
        }
                    /**
         * 
         *
