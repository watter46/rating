<div id="field" class="absolute field">
    <svg id="field-svg" class="relative hidden initial-state field__svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 74 111">
        <rect width="74" height="111" fill="#00a000"/>
        <g id="infield" fill="none" stroke="#fff" stroke-width="0.5" transform="translate(3 3)">
