<div class="flex flex-col items-center justify-center md:gap-y-3">
    <div class="flex items-center gap-x-1">
        <x-svg.machine-image class="w-4 h-4 md:w-6 md:h-6 lg:w-4 lg:h-4" />
        <p class="text-white md:text-2xl lg:text-base">/</p>
        <x-svg.user-image class="w-4 h-4 md:w-6 md:h-6 lg:w-4 lg:h-4" />
    </div>
